...
namespace Treinbeheersysteem.DAL.Contexts
{
    ...
    {
        #region Rol
        public static List<Rol> Rollen = new List<Rol>()
        {
            new Rol()
            {
                Id = 1,
        ...
        {
            new Account(1, "gebruikersnaam", Rollen.First(r => r.Id == 2), new Persoon("voornaam", "achternaam", "email"), true),
            new Account(2, "gebruikersnaa", Rollen.First(r => r.Id == 3), new Persoon("voornaam", "achternaam", "email"), true),
            new Account(3, "gebruikersna", Rollen.First(r => r.Id == 3), new Persoon("voornaam", "achternaam", "email"), true),
            new Account(4, "gebruikersn", Rollen.First(r => r.Id == 3), new Persoon("voornaam", "achternaam", "email"), true),
            new Account(5, "gebruikers", Rollen.First(r => r.Id == 2), new Persoon("voornaam", "achternaam", "email"), true),
        };
        #endregion

        #region Verbindingen
        public static List<Verbinding> Verbindingen = new List<Verbinding>()
        {
        ...
        #region Perrons
        public static List<Perron> Perrons = new List<Perron>()
        {
        ...
        #region Treinen
        public static List<Trein> Treinen = new List<Trein>()
        {
        ...
        #region Trajecten
        public static List<Traject> Trajecten = new List<Traject>()
        {
